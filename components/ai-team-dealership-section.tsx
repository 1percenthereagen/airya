...
export function AiTeamDealershipSection() {
  ...
  return (
    <section className="py-16 sm:py-24 relative z-10 perspective-[2000px]">
      <motion.div
        initial="hidden"
        whileInView="visible"
        ...
        className="bg-white/98 backdrop-blur-2xl rounded-[2rem] shadow-[0_20px_80px_-20px_rgba(0,0,0,0.3)] border border-white/40 relative overflow-hidden mx-4"
      >
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-gradient-to-br from-blue-500/20 via-purple-500/10 to-transparent rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-gradient-to-tr from-orange-500/20 via-pink-500/10 to-transparent rounded-full blur-3xl pointer-events-none" />

        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-8 sm:py-12 lg:py-16 relative z-10 perspective-[1000px]">
          ...
          >
            ...
            <motion.div
              ...
              className="lg:col-span-2 bg-gradient-to-br from-slate-50 to-blue-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg transition-all duration-300 group"
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {/* Live chat preview */}
                <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm relative overflow-hidden">
                  ...
                  <div className="space-y-2">
                    <motion.div initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ delay: 0.5 }} className="flex gap-2">
                    ...
                    <motion.div initial={{ x: 10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ delay: 0.8 }} className="flex gap-2 justify-end">
                      <div className="bg-blue-500 rounded-lg rounded-tr-sm px-3 py-1.5 text-xs text-white">
                        Do you have X5 in stock?
                      </div>
                    </motion.div>
                    <motion.div initial={{ x: -10, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ delay: 1.1 }} className="flex gap-2">
                      <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex-shrink-0"></div>
                      <div className="bg-slate-100 rounded-lg rounded-tl-sm px-3 py-1.5 text-xs text-slate-800">
            ...
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.1)" }}
              className="bg-gradient-to-br from-slate-50 to-green-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg transition-all duration-300 group"
            >
              ...
              <div className="bg-white rounded-xl p-4 mb-4 border border-slate-200/60 shadow-sm text-center">
                ...
                <div className="flex items-center justify-center gap-4 text-center pt-3 mt-3 border-t border-slate-100">
                  <div>
            ...
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.1)" }}
              className="bg-gradient-to-br from-slate-50 to-purple-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg transition-all duration-300 group"
            >
              <div className="flex items-center gap-3 mb-4">
              ...
              <div className="bg-white rounded-xl p-4 mb-4 border border-slate-200/60 shadow-sm">
                ...
                <div className="space-y-2">
                  {[
                    { label: "Oil Change", time: "10:00 AM", delay: 0.6 },
                    { label: "Brake Service", time: "2:30 PM", delay: 0.8 }
                  ].map((item, i) => (
                    <motion.div
                      key={i}
            ...
            <motion.div
              variants={itemVariants}
              whileHover={{ y: -5, boxShadow: "0 20px 40px rgba(0,0,0,0.1)" }}
              className="lg:col-span-2 bg-gradient-to-br from-slate-50 to-orange-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg transition-all duration-300 group"
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
              ...
              <div className="grid sm:grid-cols-3 gap-3">
                {[
                  { name: "Brake Pads", desc: "BMW X5 • Stock: 8", price: "€89" },
                  { name: "Oil Filter", desc: "Universal • Stock: 24", price: "€24" }
                ].map((part, i) => (
                  <div key={i} className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm hover:border-orange-200 transition-colors">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="px-2 py-0.5 bg-green-100 text-green-700 text-xs font-bold rounded">In Stock</span>
                    </div>
                    <p className="text-sm font-bold text-slate-900 mb-1">{part.name}</p>
                    <p className="text-xs text-slate-500 mb-2">{part.desc}</p>
                    <p className="text-lg font-bold text-slate-900">{part.price}</p>
                  </div>
                ))}
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border-2 border-green-200 shadow-md"
                >
                  ...
                  <p className="text-xs text-green-600">Customer notified via email & SMS</p>
                </motion.div>
              </div>

              <p className="text-sm text-slate-600 mt-4">
                Instantly responds to parts availability questions, provides accurate quotes, and processes orders while you focus on sales.
              </p>
            </motion.div>
          </motion.div>
        </div>
